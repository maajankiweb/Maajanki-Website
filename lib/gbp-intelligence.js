...
export function getGBPAnalyticsData() {
  return {
    profileInfo: {
      businessName: 'Web Development & SEO Agency in Bihar | MaaJanki Web Tech',
      primaryCategory: 'Website Designer & Software Company',
      address: 'Brajmala Complex, First Floor, Near Cinema House, Building of UCO Bank, Bagaha Bazar, West Champaran, Bihar - 845101',
      rating: 4.9,
      totalReviews: 48,
      verifiedStatus: 'VERIFIED',
      msmeRegistration: 'UDYAM-BR-38-0014113',
      profileLink: 'https://share.google/HcCrNXvxvOP3cWf99',
      phone: '+91 9006543913',
