    ...
    <footer className="footer">
      ...
      <div className="footer-container">
        ...
        <div className="footer-col">
          ...
          <ul>
            ...
            <li>
              <Link href="/industries" prefetch={false}>
                <FaAngleRight className="footer-icon" /> Industries
              </Link>
            </li>
            <li>
              <Link href="/portfolio" prefetch={false}>
                <FaAngleRight className="footer-icon" /> Portfolio
              </Link>
            </li>
            <li>
              <Link href="/reviews" prefetch={false}>
                <FaAngleRight className="footer-icon" /> Reviews
              </Link>
            </li>
            <li>
              <Link href="/locations" prefetch={false}>
                <FaAngleRight className="footer-icon" /> Locations
              </Link>
            </li>
            <li>
            ...
            <li>
              <a
                ...
                rel="noopener noreferrer"
              >
                <FaAngleRight className="footer-icon" /> Blog
              </a>
            </li>
          </ul>
        </div>
        ...
        <div className="footer-col">
          ...
          <ul>
            <li>
              <Link href="/services/web-development" prefetch={false}>
                <FaAngleRight className="footer-icon" /> Website Development
              </Link>
            </li>
            <li>
              <Link href="/services/seo" prefetch={false}>
                <FaAngleRight className="footer-icon" /> SEO
              </Link>
            </li>
            <li>
              <Link href="/services/smo" prefetch={false}>
                <FaAngleRight className="footer-icon" /> SMO
              </Link>
            </li>
            <li>
              <Link href="/services/branding" prefetch={false}>
                <FaAngleRight className="footer-icon" /> Branding
              </Link>
            </li>
            <li>
              <Link href="/services/graphic-design" prefetch={false}>
                <FaAngleRight className="footer-icon" /> Graphic Design
              </Link>
            </li>
            <li>
              <Link href="/services/ui-ux-design" prefetch={false}>
                <FaAngleRight className="footer-icon" /> UI/UX Design
              </Link>
            </li>
          </ul>
        </div>
        ...
        <div className="footer-col">
          ...
          <ul>
            <li>
              ...
              <span>First Floor, Near Cinema House, Building of UCO Bank, Bagaha Bazar, West Champaran, Bihar - 845101</span>
            </li>
            <li>
      ...
      <div className="footer-container-links">
        <ul className="footer-links">
          ...
          <li>
            <Link href="/terms-conditions" prefetch={false}>Terms & Conditions</Link>
          </li>
        </ul>
      </div>
