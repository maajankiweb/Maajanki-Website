  ...
  return (
    <div className="sticky-navbar" ref={navbarRef}>
      ...
      <nav className="main-nav">
        <div className="logo">
          <Link href="/">
            <Image priority src="/images/MaaJanki-Web-Tech-Logo.webp" alt="MaaJanki Web Tech logo – Digital Marketing and Website Development Agency in India" title="MaaJanki Web Tech | Digital Marketing & Web Development Agency" width="150" height="30"/>
          </Link>
        </div>
