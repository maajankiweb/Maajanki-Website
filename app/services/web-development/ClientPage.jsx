  ...
  return (
    <>
      ...
      <section className="custom-banner">
        ...
        <div className="banner-overlay">
          <div className="banner-content">
            <h1>
              Website Design &amp; Custom Web Development Services in Bihar &amp; India
            </h1>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Are you looking for the <strong style={{ color: "#ffffff" }}>best website development company in Bihar, India</strong>? MaaJanki Web Tech is your trusted technology partner, crafting high-performance, responsive websites for clients across Bagaha, Bettiah, Motihari, Patna, Delhi, and globally.
                </p>
              </div>
              ...
              >
                ...
                >
                  We build custom web solutions from scratch—from corporate websites to Shopify, WordPress, and full-stack MERN web applications—ensuring platforms are built for speed, security, and search engine leadership. We build <Link href="/services/seo" style={{ color: "#FD6A02", fontWeight: 600, textDecoration: "underline" }}>SEO-ready websites</Link> that are technically optimized for search and engineered to convert traffic generated by our <Link href="/services/performance-marketing" style={{ color: "#FD6A02", fontWeight: 600, textDecoration: "underline" }}>performance marketing campaigns</Link>.
                </p>
              </div>
            </div>
          </div>
      ...
      >
        ...
        <div style={{ width: "100%", background: "linear-gradient(315deg, #042544 0%, #FD6A02 100%)", }}>
          <div className="showcase-container">
            <div className="showcase-grid" style={{ direction: "rtl" }}>
              ...
              <div className="content-area" style={{ direction: "ltr" }} data-aos="fade-up-left">
                <h2 className="main-heading">4. eCommerce Website Development</h2>
                <h3 className="sub-heading">High-Conversion Online Stores Engineered with WooCommerce &amp; Shopify</h3>
                <p className="content-text">
                  We build custom eCommerce websites on WooCommerce and Shopify — designed for conversion from the first visit. Our eCommerce builds include: a streamlined product catalog architecture (category pages optimized for SEO), mobile-first checkout flow, payment gateway integration (Razorpay, PayU, Stripe), order management system, and inventory tracking.
                </p>
                <p className="content-text">
                  Every eCommerce build is tested for Core Web Vitals compliance and includes product schema, breadcrumb schema, and review schema for maximum SERP visibility. To scale paid acquisition, we pair stores with high-converting <Link href="/services/performance-marketing" style={{ color: "#FD6A02", fontWeight: 600, textDecoration: "underline" }}>dedicated landing pages</Link> that maximize Return on Ad Spend (ROAS).
                </p>
                <span className="content-cta">
                  <strong>Turn store visitors into repeat paying customers with custom eCommerce development.</strong>
                </span>
              </div>
            </div>
          </div>
        ...
        <div style={{ width: "100%", background: "linear-gradient(135deg, #042544 0%, #FD6A02 100%)", }}>
          <div className="showcase-container">
            <div className="showcase-grid">
              ...
              <div className="content-area" data-aos="fade-up-left">
                <h2 className="main-heading">5. WordPress Website Development</h2>
                <h3 className="sub-heading">Fast, Secure Custom WordPress Websites Engineered with ACF Pro &amp; Lean Themes</h3>
                <p className="content-text">
                  We build fast, secure WordPress websites for businesses that need content management flexibility without sacrificing performance. Our WordPress development process uses a lean custom theme architecture — no bloated page builders — with ACF Pro for structured content, WP Rocket for caching, and Cloudflare for CDN delivery.
                </p>
                <p className="content-text">
                  Every WordPress site is fully SEO-configured: Yoast or RankMath setup, XML sitemap, schema integration, and technical SEO audit on launch. Ideal for: service businesses, blogs, news portals, and small eCommerce stores.
                </p>
                <span className="content-cta">
                  <strong>Manage and scale your digital content with high-speed custom WordPress development.</strong>
                </span>
              </div>
            </div>
          </div>
        ...
        {/* Section 9 – Landing Page Design & Development */}
        <div style={{ width: "100%", background: "linear-gradient(135deg, #042544 0%, #FD6A02 100%)" }}>
          <div className="showcase-container">
            <div className="showcase-grid">
              <div className="visual-area" style={{ justifyContent: "flex-end" }} data-aos="fade-up-right">
                <div className="image-container">
                  <div className="main-image wd-svg-wrap">
                    <svg viewBox="0 0 520 380" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
                      ...
                      <rect width="520" height="380" fill="url(#g9)" rx="16" />
                      <rect x="70" y="45" width="380" height="260" rx="10" fill="#0d1b2a" stroke="#FD6A02" strokeWidth="2" />
                      <rect x="70" y="45" width="380" height="32" rx="10" fill="#042544" />
                      <circle cx="95" cy="61" r="5" fill="#ef4444" />
                      <circle cx="110" cy="61" r="5" fill="#f59e0b" />
                      <circle cx="125" cy="61" r="5" fill="#10b981" />
                      <rect x="90" y="95" width="200" height="18" rx="4" fill="#ffffff" opacity="0.9" />
                      <rect x="90" y="122" width="240" height="10" rx="3" fill="#cbd5e1" opacity="0.6" />
                      <rect x="90" y="140" width="180" height="10" rx="3" fill="#cbd5e1" opacity="0.6" />
                      <rect x="90" y="170" width="120" height="34" rx="6" fill="#FD6A02" />
                      <text x="150" y="192" textAnchor="middle" fill="#fff" fontSize="12" fontWeight="bold">Get Free Audit</text>
                      <rect x="310" y="95" width="120" height="160" rx="8" fill="#1e293b" stroke="#334155" strokeWidth="1" />
                      <rect x="325" y="115" width="90" height="16" rx="4" fill="#334155" />
                      <rect x="325" y="145" width="90" height="16" rx="4" fill="#334155" />
                      <rect x="325" y="175" width="90" height="16" rx="4" fill="#334155" />
                      <rect x="325" y="210" width="90" height="26" rx="4" fill="#22c55e" />
                      <text x="370" y="227" textAnchor="middle" fill="#fff" fontSize="10" fontWeight="bold">Submit</text>
                      <text x="260" y="345" textAnchor="middle" fill="rgba(255,255,255,0.4)" fontSize="11">High-Converting Landing Page Design</text>
                    </svg>
                  </div>
                </div>
              </div>
              <div className="content-area" data-aos="fade-up-left">
                <h2 className="main-heading">9. Landing Page Design &amp; Development</h2>
                <h3 className="sub-heading">High-Converting Campaign Landing Pages Engineered to Turn Visitors into Leads</h3>
                <p className="content-text">
                  A high-converting landing page has one job: turn visitors into leads. We design and build dedicated campaign landing pages with a single CTA, minimal navigation (no menu distractions), social proof elements (reviews, client logos, trust badges), and fast load times.
                </p>
                <p className="content-text">
                  Built in Next.js or WordPress, our landing pages integrate directly with your CRM or email platform and include conversion event tracking via GA4 and Google Tag Manager from day one.
                </p>
                <span className="content-cta">
                  <strong>Turn ad clicks into paying clients with high-converting custom landing pages.</strong>
                </span>
              </div>
            </div>
          </div>
                      ...
                      onSubmit={(e) => {
                        ...
                        fetch("/api/leads", {
                          ...
                          body: JSON.stringify({
                            ...
                            service: "Brochure Download - Web Development",
