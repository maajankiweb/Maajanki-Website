          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  We build custom web solutions from scratch—from corporate websites to Shopify, WordPress, and full-stack MERN web applications—ensuring platforms are built for speed, security, and search engine leadership. We build <Link href="/services/seo" style={{ color: "#FD6A02", fontWeight: 600, textDecoration: "none" }}>SEO-ready websites</Link> that are technically optimized for search and engineered to convert traffic generated by our <Link href="/services/performance-marketing" style={{ color: "#FD6A02", fontWeight: 600, textDecoration: "none" }}>performance marketing campaigns</Link>.
                </p>
              </div>
            </div>
          </div>
