...
export const metadata = {
  title: 'Admin Portal Login | MaaJanki Web Tech',
  description: 'Secure admin portal sign in for MaaJanki Web Tech',
    ...
    <main className="auth-3d-wrapper">
      ...
      <div className="auth-3d-stage">
        ...
        <div className="auth-3d-badge badge-top-left">
          <span>⚡ Ultra Secure Portal</span>
        </div>
        <div className="auth-3d-badge badge-bottom-right">
          <span>🛡️ MaaJanki Admin</span>
        </div>
        ...
        <div className="auth-3d-header">
          ...
          <h1 className="auth-3d-title">Welcome Back</h1>
          <p className="auth-3d-subtitle">Sign in to access your administrative control center</p>
        </div>
