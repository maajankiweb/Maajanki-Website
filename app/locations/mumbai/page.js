...
export const metadata = {
  title: "Web Design & Digital Marketing Agency in Mumbai, Bihar | Maajanki Web Tech",
  description: "MaaJanki Web Tech is the leading web design agency and digital marketing company in Mumbai, Bihar. We offer custom web development, local SEO, and paid ads. Contact us today!",
  keywords: ["web design agency Mumbai", "website developer West Champaran", "digital marketing agency Mumbai", "SEO services Mumbai", "MaaJanki Web Tech"],
  alternates: {
...
export default function Page() {
  const localBusinessSchema = {
    ...
    "name": "Maajanki Web Tech",
    "description": "Professional website development and digital marketing agency in Mumbai, West Champaran, Bihar.",
    ...
    "areaServed": ["Mumbai", "Bagaha", "Narkatiaganj", "Raxaul", "Motihari", "West Champaran", "East Champaran", "Bihar"],
    "priceRange": "₹₹",
    ...
    <>
      ...
      <section className="custom-banner">
        <Image 
          ...
          alt="MaaJanki Web Tech Mumbai office banner" 
          title="Web Design & Digital Marketing Agency in Mumbai, Bihar" 
          width="1280" 
          height="720"
        />
        <div className="banner-overlay">
          <div className="banner-content">
            <h1>
              Web Design & Digital Marketing Agency in Mumbai, Bihar
            </h1>
            <p>
          ...
          <div className="row justify-content-around">
            ...
            <div className="col-md-5">
              <div className="contact-us-content p-4 bg-white h-100">
                <h2 className="mb-3">Why Choose MaaJanki Web Tech in Mumbai?</h2>
      ...
      <section className="google-map-section">
        <div className="google-map-container">
          <iframe
            title="MaaJanki Web Tech Mumbai Office Location"
