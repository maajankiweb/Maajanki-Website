...
export const metadata = {
  title: "Web Design & Digital Marketing Agency in Norway | MaaJanki Web Tech",
  description: "MaaJanki Web Tech is the leading web design agency and digital marketing company serving clients in Norway. We offer custom web development, global SEO, and paid ads.",
  keywords: ["web design agency Norway", "web developer Norway", "digital marketing agency Norway", "SEO services Norway", "MaaJanki Web Tech"],
  alternates: {
...
export default function Page() {
  const localBusinessSchema = {
    ...
    "description": "Professional website development and digital marketing agency serving Norway.",
    ...
    <>
      ...
      <section className="custom-banner">
        <Image 
          ...
          alt="MaaJanki Web Tech Norway banner" 
          title="Web Design & Digital Marketing Agency in Norway" 
          width="1280" 
          height="720"
        />
        <div className="banner-overlay">
          <div className="banner-content">
            <h1>
              Web Design & Digital Marketing Agency in Norway
            </h1>
            <p>
              Expand your digital presence in Norway with our high-performance web development, 
          ...
          <div className="contact-promo-grid">
            ...
            >
              <div className="contact-promo-card">
                ...
                <p className="contact-promo-text">Serving Norway</p>
              </div>
            </a>
            ...
            <a
              href="https://wa.me/919006543913?text=Hello%20MaaJanki%20Web%20Tech!%20I%20need%20web%20services%20in%20Norway."
              className="contact-link"
            >
              <div className="contact-promo-card">
          ...
          <div className="row justify-content-around">
            ...
            <div className="col-md-5">
              <div className="contact-us-content p-4 bg-white h-100">
                <h2 className="mb-3">Why Choose MaaJanki Web Tech in Norway?</h2>
                <p className="lead text-muted">
                  We are a cost-effective, high-quality digital partner for businesses in Norway. 
                ...
                <div className="nap-section my-4 p-3 bg-light border rounded">
                  ...
                  <p className="mb-2">
                    <strong>Target Market:</strong> Norway
                  </p>
                  <p className="mb-2">
