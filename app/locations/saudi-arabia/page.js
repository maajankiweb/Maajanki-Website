...
export const metadata = {
  title: "Web Design & Digital Marketing Agency in Saudi Arabia | MaaJanki Web Tech",
  description: "MaaJanki Web Tech is the leading web design agency and digital marketing company serving clients in Saudi Arabia. We offer custom web development, global SEO, and paid ads.",
  keywords: ["web design agency Saudi Arabia", "web developer Saudi Arabia", "digital marketing agency Saudi Arabia", "SEO services Saudi Arabia", "MaaJanki Web Tech"],
  alternates: {
...
export default function Page() {
  const localBusinessSchema = {
    ...
    "description": "Professional website development and digital marketing agency serving Saudi Arabia.",
    ...
    "areaServed": ["Saudi Arabia", "Global"],
    "priceRange": "$$",
    ...
    <>
      ...
      <section className="custom-banner">
        <Image 
          ...
          alt="MaaJanki Web Tech Saudi Arabia banner" 
          title="Web Design & Digital Marketing Agency in Saudi Arabia" 
          width="1280" 
          height="720"
        />
        <div className="banner-overlay">
          <div className="banner-content">
            <h1>
              Web Design & Digital Marketing Agency in Saudi Arabia
            </h1>
            <p>
              Expand your digital presence in Saudi Arabia with our high-performance web development, 
          ...
          <div className="contact-promo-grid">
            ...
            >
              <div className="contact-promo-card">
                ...
                <p className="contact-promo-text">Serving Saudi Arabia</p>
              </div>
            </a>
            ...
            <a
              href="https://wa.me/919006543913?text=Hello%20MaaJanki%20Web%20Tech!%20I%20need%20web%20services%20in%20Saudi%20Arabia."
              className="contact-link"
            >
              <div className="contact-promo-card">
          ...
          <div className="row justify-content-around">
            ...
            <div className="col-md-5">
              <div className="contact-us-content p-4 bg-white h-100">
                <h2 className="mb-3">Why Choose MaaJanki Web Tech in Saudi Arabia?</h2>
                <p className="lead text-muted">
                  We are a cost-effective, high-quality digital partner for businesses in Saudi Arabia. 
                ...
                <div className="nap-section my-4 p-3 bg-light border rounded">
                  ...
                  <p className="mb-2">
                    <strong>Target Market:</strong> Saudi Arabia
                  </p>
                  <p className="mb-2">
