...
export const metadata = {
  title: "Web Design & Digital Marketing Agency in Narkatiaganj, Bihar | Maajanki Web Tech",
  description: "MaaJanki Web Tech is the leading web design agency and digital marketing company in Narkatiaganj, Bihar. We offer custom web development, local SEO, and paid ads. Contact us today!",
  keywords: ["web design agency Narkatiaganj", "website developer West Champaran", "digital marketing agency Narkatiaganj", "SEO services Narkatiaganj", "MaaJanki Web Tech"],
  alternates: {
...
export default function Page() {
  const localBusinessSchema = {
    ...
    "name": "Maajanki Web Tech",
    "description": "Professional website development and digital marketing agency in Narkatiaganj, West Champaran, Bihar.",
    ...
    "areaServed": ["Narkatiaganj", "Bagaha", "Narkatiaganj", "Raxaul", "Motihari", "West Champaran", "East Champaran", "Bihar"],
    "priceRange": "₹₹",
    ...
    <>
      ...
      <section className="custom-banner">
        <Image 
          ...
          alt="MaaJanki Web Tech Narkatiaganj office banner" 
          title="Web Design & Digital Marketing Agency in Narkatiaganj, Bihar" 
          width="1280" 
          height="720"
        />
        <div className="banner-overlay">
          <div className="banner-content">
            <h1>
              Web Design & Digital Marketing Agency in Narkatiaganj, Bihar
            </h1>
            <p>
          ...
          <div className="row justify-content-around">
            ...
            <div className="col-md-5">
              <div className="contact-us-content p-4 bg-white h-100">
                <h2 className="mb-3">Why Choose MaaJanki Web Tech in Narkatiaganj?</h2>
      ...
      <section className="google-map-section">
        <div className="google-map-container">
          <iframe
            title="MaaJanki Web Tech Narkatiaganj Office Location"
