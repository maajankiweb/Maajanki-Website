...
export const metadata = {
  title: "Best Website Development Agency & Software Company in Muzaffarpur, Bihar | MaaJanki Web Tech",
  description: "MaaJanki Web Tech is top-rated as the best website development agency and software company in Muzaffarpur, Bihar. We build Next.js web apps, e-commerce stores, and local SEO.",
  keywords: [
    ...
    "Software Company in Muzaffarpur",
...
export default function Page() {
  const localBusinessSchema = {
    ...
    "name": "Maajanki Web Tech",
    "description": "Professional website development and digital marketing agency in Muzaffarpur, West Champaran, Bihar.",
    ...
    "areaServed": ["Muzaffarpur", "Bagaha", "Narkatiaganj", "Raxaul", "Motihari", "West Champaran", "East Champaran", "Bihar"],
    "priceRange": "₹₹",
    ...
    <>
      ...
      <section className="custom-banner">
        <Image 
          ...
          alt="MaaJanki Web Tech Muzaffarpur office banner" 
          title="Web Design & Digital Marketing Agency in Muzaffarpur, Bihar" 
          width="1280" 
          height="720"
        />
        <div className="banner-overlay">
          <div className="banner-content">
            <h1>
              Web Design & Digital Marketing Agency in Muzaffarpur, Bihar
            </h1>
            <p>
          ...
          <div className="row justify-content-around">
            ...
            <div className="col-md-5">
              <div className="contact-us-content p-4 bg-white h-100">
                <h2 className="mb-3">Why Choose MaaJanki Web Tech in Muzaffarpur?</h2>
                ...
                <div className="nap-section my-4 p-3 bg-light border rounded">
                  ...
                  <p className="mb-2">
                    <strong>Bagaha Regional Office address:</strong> Brajmala Complex, First Floor, Near Cinema House, Front of UCO Bank, Bagaha Bazar, West Champaran, Bihar - 845101
                  </p>
                  <p className="mb-2">
      ...
      <section className="google-map-section">
        <div className="google-map-container">
          <iframe
            title="MaaJanki Web Tech Muzaffarpur Office Location"
