          ...
          <div className="row justify-content-center">
            <div className="col-lg-10">
              ...
              <p style={{ color: "rgba(255, 255, 255, 0.95)", fontSize: "16px", lineHeight: "1.8" }}>
                ...
                customers through our <Link href="/services" style={{ color: "#ffffff", fontWeight: 700, textDecoration: "none" }}>full service portfolio</Link> of strategic, data-driven digital solutions.
              </p>
